...
func show_moves{output_ptr : felt*, bitwise_ptr : BitwiseBuiltin*}(list_of_moves: felt*, size: felt):
    ...
    let (local_rep) = get_rep([list_of_moves])
    serialize_word(local_rep)
...
func get_rep{output_ptr : felt*, bitwise_ptr : BitwiseBuiltin*}(move: felt)->(rep: felt):
    alloc_locals
...
# SOME FUNCTIONS TO DEAL WITH THE PATTERN 
func get_binary_word{output_ptr : felt*, bitwise_ptr : BitwiseBuiltin*}(
...
func put_binary_word{output_ptr : felt*, bitwise_ptr : BitwiseBuiltin*}(
